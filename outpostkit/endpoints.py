...
class Endpoint(Namespace):
    ...
    def deploy(self, wakeup: bool = True) -> EndpointDeployResponse:  # noqa: FBT001, FBT002
        """
        Deploy the endpoint.
        """
        ...
        if isinstance(templateConfig, EndpointAutogeneratedTemplateConfig):
            resp = self._client._request(
                ...
                json={
                    ...
                    "replicaScalingConfig": replica_scaling_config,
                    "name": name,
                    "prebuiltImageName": prebuilt_image_name,
                    "containerType": containerType,
                    "taskType": task_type,
                    "autogeneratedTemplateConfig": templateConfig.__dict__,
                },
            )
        else:
